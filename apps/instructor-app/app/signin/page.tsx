...
export default function SignIn() {
    ...
    return <div className='flex justify-center items-center flex-col h-[90vh] '>
        <div className='p-4 rounded shadow-xl bg-[#b3a885] flex justify-center items-center flex-col'>
                ...
                <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
                    <div className="px-5 py-7">
                        ...
                        <button onClick={async () => {
                            ...
                            }} type="button" className="transition duration-200 bg-[#CFC1FF] hover:bg-[#b7a8e9] focus:bg-[#8f81bc] focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
