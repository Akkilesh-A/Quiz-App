...
export default function SignIn() {
    ...
    return <div className='flex justify-center items-center flex-col h-[90vh] '>
        <div className='p-4 rounded shadow-xl bg-[#d0f6b1] flex justify-center items-center flex-col'>
            <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                <h1 className="font-bold text-center text-2xl mb-5">🎓iPropel Admin Login</h1>
                <div className="bg-[#fffbef] shadow w-full rounded-lg divide-y divide-gray-200">
                    <div className="px-5 py-7">
                        ...
                        <button onClick={async () => {
                            ...
                            }} type="button" className="transition duration-200 bg-[#ab94f4] hover:bg-[#9d86e9] focus:bg-[#8f81bc] focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
                    <span className="inline-block mr-2">Login with Username</span>
            ...
            <button  onClick={async () => {
                ...
                className="flex mb-4 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
